...
- If the user asks to change header or footer text (e.g. "put the date on the right", "remove the company from the header") or to change logo position (e.g. "move the logo to the header"): call editDocument immediately. The editDocument tool can return a layoutConfig field alongside prose changes to update header/footer text and logo position.{{imageInstruction}}
