...
8. layoutConfig: include at the top level ONLY when the user asks to change header/footer text or logo position. Allowed logoPosition values: "header-left", "header-right", "cover-top-left", "cover-top-center", "cover-top-right", "cover-bottom-left", "cover-bottom-center", "cover-bottom-right", "none". Use "cover-top-right" as the default cover position when the user asks to place the logo on the cover page without specifying a position. Leave layoutConfig out entirely if not requested.
